...
function() {
    ...
    a.jsPlumbToolkitInstance = function(i) {
        ...
        var j = i.idFunction || h
          ...
          , D = i.saveUrl
          , E = i.onAutoSaveSuccess || function() {}
          , F = i.onAutoSaveError || function() {}
          , G = i.doNotUpdateOriginalData === !0
          , H = {
          ...
          , I = i.createMissingGroups === !0;
        b.EventGenerator.apply(this, arguments);
        var J = new e.Graph(H);
        C && new d.AutoSaver(this,D,E,F),
        ...
        ;
        var K, L = function() {
            return null == K && (K = new a.jsPlumbToolkit.Model(w || {})),
            K
        }, M = function(a, b) {
            if (null == w)
                return !0;
        ...
        .bind(this);
        this.beforeConnect = i.beforeConnect || M,
        this.beforeMoveConnection = i.beforeMoveConnection || M,
        ...
        this.connect = function(a) {
            ...
            var b;
            if (!u) {
                var d = J.getVertex(a.source)
                  , e = J.getVertex(a.target)
                  , f = a.cost
                  , g = a.directed;
                if (!d) {
                    if (a.doNotCreateMissingNodes)
                        return;
                    d = J.addVertex(a.source),
                    t.fire("nodeAdded", {
                        data: {},
                        node: d
                    })
        ...
        ,
        this.getNodeCount = function() {
            return J.getVertexCount()
        }
        ,
        this.getNodeAt = function(a) {
            return J.getVertexAt(a)
        }
        ,
        this.getNodes = function() {
            return J.getVertices()
        }
        ,
        this.eachNode = function(a) {
            for (var b, c = 0, d = J.getVertexCount(); d > c; c++)
                b = J.getVertexAt(c),
                a(c, b)
        }
        ,
        this.eachGroup = function(a) {
            for (var b, c = 0, d = J.getGroupCount(); d > c; c++)
                b = J.getGroupAt(c),
                a(c, b)
        }
        ,
        this.eachEdge = function(a) {
            for (var b = J.getEdges(), c = 0, d = b.length; d > c; c++)
                a(c, b[c])
        }
        ,
        this.getEdgeCount = function() {
            return J.getEdgeCount()
        }
        ,
        this.getGroupCount = function() {
        ...
        this.addNode = function(b, c, e) {
            ...
            if (null != g) {
                ...
                if ("string" != typeof b && null != b.group) {
                    ...
                    null == k && I && (k = J.addGroup(b.group)),
                    null != k && k.addVertex(g)
                }
                return S || G || a.jsPlumbToolkitIO.manage("addNode", Q, R, g, j || J.getIdFunction(), t),
                e || t.fire("nodeAdded", {
                    data: b,
                    node: g,
                    eventInfo: c
        ...
        this.addGroup = function(b, c, e) {
            var f = j(b);
            null == f && "string" != typeof b && (b.id = d.uuid());
            var g = J.addGroup(b, j);
            return S || G || a.jsPlumbToolkitIO.manage("addGroup", Q, R, g, j || J.getIdFunction(), t),
            e || t.fire("groupAdded", {
                data: b,
                group: g,
                eventInfo: c
        ...
        this.removeGroup = function(b, c, d) {
            var e = J.deleteGroup(b, c);
            e && (S || G || a.jsPlumbToolkitIO.manage("removeGroup", Q, R, e, j || J.getIdFunction(), t),
        ...
        this.exists = function(a) {
            for (var b = 0; b < arguments.length; b++)
                if (null == J.getVertex(arguments[b]))
                    return !1;
            return !0
        }
        ,
        this.removeNode = function(b, c) {
            b = b.constructor == e.Vertex || b.constructor == e.Port ? b : J.getVertex(b);
            for (var d = b.getAllEdges() || [], f = 0; f < d.length; f++)
                t.removeEdge(d[f]);
            return J.deleteVertex(b.id),
            S || G || a.jsPlumbToolkitIO.manage("removeNode", Q, R, b, j || J.getIdFunction(), t),
        ...
        this.addEdge = function(b, c, d) {
            var e = J.addEdge(b, o, this.beforeConnect);
            return S || G || a.jsPlumbToolkitIO.manage("addEdge", Q, R, e, o || J.getIdFunction(), t),
            d || t.fire("edgeAdded", {
                edge: e,
                source: c,
                geometry: b.geometry,
        ...
        this.removeEdge = function(b, c) {
            return b = J.getEdge(b),
            null != b && (J.deleteEdge(b),
            S || G || a.jsPlumbToolkitIO.manage("removeEdge", Q, R, b, o || J.getIdFunction(), t),
            t.fire("edgeRemoved", {
                edge: b,
                source: c
            }, null )),
        ...
        this.setTarget = function(a, b, c) {
            var d = J.setTarget.apply(J, arguments);
            return d.success === !1 || c || t.fire("edgeTarget", d),
            d
        }
        ,
        this.setSource = function(a, b, c) {
            var d = J.setSource.apply(J, arguments);
        ...
        this.addNewPort = function(b, c, d, e) {
            ...
            A({
                ...
                var d = q(c)
                  , f = b.addPort(d);
                f.data = c,
                S || G || a.jsPlumbToolkitIO.manage("addPort", Q, R, {
                    node: b,
                    port: f
                }, q || J.getIdFunction(), t),
                e || t.fire("portAdded", {
        ...
        this.addPort = function(b, c, d) {
            var e = b.addPort(c, q);
            return S || G || a.jsPlumbToolkitIO.manage("addPort", Q, R, {
                node: b,
                port: e
            }, q || J.getIdFunction(), t),
            d || t.fire("portAdded", {
        ...
        this.removePort = function(a, b, c) {
            var d = !1;
            a = a.constructor == e.Vertex || a.constructor == e.Port ? a : J.getVertex(a);
            var f = a.getPort(b);
            if (f) {
                var g = f.getAllEdges();
                if (d = a.removePort(f),
        ...
        ;
        var O = this.findGraphObject = function(a) {
            return null == a ? null : "*" === a ? J : a.constructor == e.Vertex || a.constructor == e.Port ? a : b.isString(a) || b.isObject(a) ? J.getVertex(a) : null
        }
          , P = function(a, b, c) {
            a = a || {};
            var d = []
              ...
              , h = function(d, f, h, i) {
                if (null != d)
                    for (var j = d[b]({
                        ...
                        var l = f && d == J || j[k].source == d || c && j[k].source.constructor == e.Port && j[k].source.getNode() == d
                          , m = h && d == J || j[k].target == d || c && j[k].target.constructor == e.Port && j[k].target.getNode() == d;
                        (f && l || h && m || i && (l || m)) && g(j[k])
                    }
            };
            return h(O(a.source), !0, !1, !1),
            h(O(a.target), !1, !0, !1),
            h(O(a.element), !1, !1, !0),
            d
        };
        this.getEdges = function(a) {
            return P(a, "getEdges", !1)
        }
        ,
        this.getAllEdges = function() {
            return J.getAllEdges()
        }
        ,
        ...
        this.load = function(a) {
            return T(a, "dataLoadStart", "dataLoadEnd")
        }
        ,
        this.append = function(a) {
            return T(a, "dataAppendStart", "dataAppendEnd")
        }
        ,
        ...
        i.maxSelectedNodes && V.setMaxNodes(i.maxSelectedNodes),
        i.maxSelectedEdges && V.setMaxEdges(i.maxSelectedEdges),
        i.selectionCapacityPolicy && V.setCapacityPolicy(i.selectionCapacityPolicy);
    ...
    c.AbstractLayout = function(b) {
        ...
        var E = function(a, b) {
          ...
          , K = function(a, b) {
            ...
            if (null != c) {
                var e = p[a];
                return d.adapter.setAbsolutePosition(c, e, b),
                O[a] = [e[0], e[1]],
                e.concat(E(a))
            }
            return null
...
function() {
    ...
    var b = this
      ...
      , k = function(b) {
        ...
        function e(a) {
            var b = "";
            u[a.endpoint.type] && (b = u[a.endpoint.type](a.endpoint, a.x, a.y)),
            r += b
        }
        function f(a, b, c, d) {
            var e = {
              ...
              , f = n.render(a.el, e, a.el.jtk.node.data, d);
            return p += f.xml || f,
            f.bounds || e
        }
        function k(a, b, c, d) {
            return m = "0 0 " + (b + 2 * o) + " " + (c + 2 * o),
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="' + m + '">'
        }
        function l(a) {
            return a + p + q + r + "</svg>"
        }
        b = b || {};
        var m, n = b.nodeRenderer || new g, o = b.padding || 10, p = "", q = "", r = "", s = b.getEndpointStyle || i, t = b.getConnectorStyle || j, u = {
            Dot: function(b, c, e) {
    ...
    e.Renderers.AbstractRenderer.prototype.toSvg = function(a) {
        var b = this.getToolkit()
          , c = this.getView();
        return a = a || {},
        this.getJsPlumb().toSvg({
            getConnectorStyle: function(a) {
                var e = b.getEdgeType(a.edge.data)
                  , f = c.getEdgeDefinition(e);
                return d.extend({
                    stroke: "#CCC",
                    fill: "none",
                    "stroke-width": "2"
...
function() {
    ...
    c.Miniview = function(a) {
        ...
        var L = function(a) {
            ...
            e.setAbsolutePosition(l.nodeMap[(a.node || a.group).id], a.pos),
            K(!0),
